                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                ...
                                <a href="{{ $settings->fb_link }}" target="_blank" class="instagram"><i class="fab fa-instagram"></i></a>
                                <a href="{{ $settings->fb_link }}" target="_blank" class="twitter"><i class="fab fa-twitter"></i></a>
                                <a href="{{ $settings->fb_link }}" target="_blank" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="member">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="{{ route('get.notification.settings') }}">
                                                <i class="far fa-bell"></i>
                                                اعدادات الاشعارات
                                            </a>
                                            <a class="dropdown-item" href="{{ route('client.favourites') }}">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('who_we_are') }}">من نحن</a>
                            </li>
                            <li class="nav-item">
                        ...
                        @guest('client')
                            <div class="accounts">
                                <a href="{{ route('client.get.register') }}" class="create">إنشاء حساب جديد</a>
                                <a href="{{ route('client.get.login') }}" class="signin">الدخول</a>
                            </div>
                        @endguest
                    ...
                    <div class="row">
                        ...
                        <div class="pages col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action" id="list-settings-list" href="{{ route('who_we_are') }}" role="tab" aria-controls="settings">من نحن</a>
